...
#ifndef AZROTSD
/* *** Azimuthal rotation variation [deg]
   Azimuthal angle is even between the offsets of the same parent = 360/Num_lat_buds
   This value, if nonzero, adds gaussian noise to the angle. Namely, AZROTSD =
